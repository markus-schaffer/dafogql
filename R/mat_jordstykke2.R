...
#' @param sfe           Character vector of one or more SFEs (samlet Fast Ejendom)
...
mat_jordstykke2 <- function(
  ...
  daf_query(
    ...
    where_builder = function(ids) list(samletFastEjendomLokalId = list(`in` = ids)),
